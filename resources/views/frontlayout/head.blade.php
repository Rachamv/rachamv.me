<head>
    <meta charset="utf-8">
    <title>Rachamv Personal Portfolio</title>
    ...
    <!-- CSS Skin File -->
    <link href="{{ url('public/css/yellow.css')}}" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('public/css/styleswitcher.css')}}">
